  ...
  <div class="book-detail">
    ...
    <scroll class="content-wrapper"
      ...
      <div class="book-detail-content-wrapper">
        <div class="book-detail-content-title">{{$t('detail.intro')}}</div>
        <div class="book-detail-content-list-wrapper">
          <div class="book-detail-content-row">
            <div class="book-detail-content-text">{{this.description}}</div>
          </div>
        </div>
      </div>
      <div class="book-detail-content-wrapper">
...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      this.metadata = this.detailMetadata
      this.description = this.detailDescription
      this.navigation = this.detailNavigation
      this.categoryText = this.detailCategoryText
      this.titleText = this.detailTitleText
    },
    back () {
      this.$router.go(-1)
    },
    ...
    read (item) {
      let bookItemKey = `${this.data.categoryText}|${this.data.fileName}`
